...
class AboutWithStatements(Koan):
    ...
    def test_counting_lines(self):
        self.assertEqual(4, self.count_lines("example_file.txt")) #lines of the file
    ...
    def find_line2(self, file_name):
        ...
        with self.FileContextManager(file_name) as file:
            for line in file.readlines():  #loop throgh
                if re.search('e', line): #search if the line includes 'e'
