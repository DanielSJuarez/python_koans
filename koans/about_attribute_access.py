...
class AboutAttributeAccess(Koan):
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        self.assertRegex(catcher.foobar, "Someone called 'foobar' and it could not be found") #passes the return plus the passes attribute name
    ...
    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        ...
        self.assertRegex(err_msg, "'str' object is not callable") #error message
    ...
    def test_changes_to_the_getattribute_implementation_affects_getattr_function(self):
        ...
        self.assertRegex(getattr(catcher, 'any_attribute'), "Someone called 'any_attribute' and it could not be found") #has to bee the specified attribute
    ...
    def test_getattribute_is_a_bit_overzealous_sometimes(self):
        ...
        catcher.my_method()
        global stack_depth
        self.assertEqual(11, stack_depth) #continues to be value outside of the max of 10 requirements
    ...
    def test_getattr_only_catches_unknown_attributes(self):
        ...
        self.assertEqual('DuffObject', #object being called
    ...
    def test_setattr_intercepts_attribute_assignments(self):
        ...
        self.assertEqual('blueberry', fanboy.a_pie)  #setter for this class

        #
        # NOTE: Change the prefix to make this next assert pass
        #

        prefix = 'my' #attribute prefixer from line 157
