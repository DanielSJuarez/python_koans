...
class AboutControlStatements(Koan):
    ...
    def test_if_then_elif_else_statements(self):
        if False:
            ...
            result = 'true value'   #follows the flow of true
        else:
            result = 'default value'
        self.assertEqual('true value', result)
    ...
    def test_while_statement(self):
        ...
        while i <= 10:
            result = result * i
            i += 1
        self.assertEqual(3628800, result) #accum multiplication

    def test_break_statement(self):
        i = 1
        result = 1
        while True:
            if i > 10: break #accum multiplication
            result = result * i
            i += 1
    ...
    def test_continue_statement(self):
        ...
        while i < 10:
            ...
            if (i % 2) == 0: continue
            result.append(i)
        self.assertEqual([1, 3, 5,7,9], result) #i % 2- ==0 will skip value of two and rerun the loop
    ...
    def test_for_statement_with_tuples(self):
        ...
        text = "Contestant: 'Robin'   Answer: 'Blue! I mean Green!'"    #takes the destructed values and appedning to the string
