...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        self.assertEqual({'MacLeod', 'Ramirez', 'Matunas', 'Malcolm'}, there_can_only_be_only_one) #removes duplicate values

    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        self.assertEqual({1, 2, 3}, {1, 2, 3})
        self.assertEqual(set(), set()) #empty set is () with set
    ...
    def test_creating_sets_using_strings(self):
        ...
        self.assertEqual({'1','2','3','4','5'}, set('12345')) #creates the set syntax from a string
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'MacLeod', 'Wallace'}, scotsmen & warriors) #gets set that are equal of the two
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors) #get set that or not equal of the two
