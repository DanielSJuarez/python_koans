...
class AboutIteration(Koan):
    ...
    def test_iterating_with_next(self):
        ...
        try:
            ...
            next(stages) #skipping beta
            self.assertEqual('gamma', next(stages))
            next(stages)
        except StopIteration as ex:
            err_msg = 'Ran out of iterations'

        self.assertRegex(err_msg, 'Ran out of iterations') #passing the error message
    ...
    def test_map_transforms_elements_of_a_list(self):
        ...
        self.assertEqual([11,12,13], mapped_seq) #maps over the list and adds the new requirements to it
    ...
    def test_filter_selects_certain_items_from_a_list(self):
        ...
        for item in filter(is_even, seq): #filters for even values
    ...
    def test_filter_returns_all_items_matching_criterion(self):
        ...
        try:
            ...
            msg = 'Ran out of big names' #error message after there are not remaining big names
    ...
    def test_use_pass_for_iterations_with_no_body(self):
        ...
        self.assertEqual(4, num) #takes the loop count
    ...
    def test_all_iteration_methods_work_on_any_sequence_not_just_lists(self):
        ...
        self.assertEqual([11,12,13], list(result)) #new list with the values starting with one then stopping before 4 and adding ten to each
