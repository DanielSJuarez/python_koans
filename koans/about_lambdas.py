...
class AboutLambdas(Koan):
    ...
    def test_accessing_lambda_via_assignment(self):
        ...
        self.assertEqual('3 sausages', sausages(3)) #is taking the lambda name and put the passed in qty based on the make_order 
        self.assertEqual('2 eggs', eggs(2))

    def test_accessing_lambda_without_assignment(self):
        self.assertEqual('39823 spam', self.make_order('spam')(39823))
