...
class AboutDeletingObjects(Koan):
    ...
    def test_del_can_remove_entire_lists(self):
        ...
        with self.assertRaises(NameError): win = lottery_nums #since the object doesn't exist
    ...
    def test_del_can_remove_attributes(self):
        ...
        self.assertRegex(err_msg1, "'ClosingSale' object has no attribute 'toilet_brushes'") #elements are not available for access once removed
    ...
    def test_del_works_with_properties(self):
        ...
        del cowboy.name
        self.assertEqual("The man with no name", cowboy.name) #doesn't exist to pass
    ...
    def test_another_way_to_make_a_deletable_property(self):
        ...
        del citizen.name
        self.assertEqual("Number Six", citizen.name) #previous value
