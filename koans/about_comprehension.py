...
class AboutComprehension(Koan):
    ...
    def test_creating_lists_with_list_comprehensions(self):
        ...
        self.assertEqual('Lambs', comprehension[0]) #compression creates a new list and this is just taking index value
    ...
    def test_unpacking_tuples_in_list_comprehensions(self):
        ...
        self.assertEqual('spamspamspamspam', comprehension[2]) #takes the index and then the number of time of the key and displays the value
    ...
    def test_double_list_comprehension(self):
        ...
        self.assertEqual(6, len(comprehension)) #length of both eggs and meat
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        self.assertEqual(4, len(dict_comprehension)) #doesn't take the value of none
