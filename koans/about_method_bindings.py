...
class AboutMethodBindings(Koan):
    ...
    def test_methods_are_also_bound_to_a_function(self):
        obj = Class()
        self.assertEqual('parrot', obj.method()) #returns the function value
        self.assertEqual('parrot', obj.method.__func__(obj)) #returns the function value

    def test_functions_have_attributes(self):
        obj = Class()
        self.assertEqual(35, len(dir(function))) #length of the dir attr
        self.assertEqual(True, dir(function) == dir(obj.method.__func__)) #function for function
    ...
    def test_functions_can_have_inner_functions(self):
        ...
        self.assertEqual('pineapple', function2.get_fruit()) #reseting the value of function2 to function
