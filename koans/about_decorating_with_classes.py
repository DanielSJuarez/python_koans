...
class AboutDecoratingWithClasses(Koan):
    ...
    def test_partial_that_wrappers_no_args(self):
        ...
        self.assertEqual(23, max(7,23)) #comparing the values, and returning the great that is the function
    ...
    def test_partial_that_wrappers_first_arg(self):
        ...
        self.assertEqual(5, max0(5)) #passing the arugment value
    ...
    def test_decorator_with_no_arguments(self):
        ...
        self.assertEqual('foo, foo', self.foo()) #running foo that returns foo
        self.assertEqual('PIECES OF EIGHT, PIECES OF EIGHT', self.parrot('pieces of eight')) #decoding foo and set the values to upper
    ...
    def test_what_a_decorator_is_doing_to_a_function(self):
        ...
        self.assertEqual('Testing..., Testing...', self.sound_check()) #runs twice as sound_check is calling sound_check
    ...
    def test_we_can_chain_decorators(self):
        self.assertEqual("D'oh, D'oh, D'oh, D'oh", self.homer()) #runns the function 3 times
        self.assertEqual("DOH!", self.homer.__doc__) #just grabs the docs
